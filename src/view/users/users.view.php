<div class="page-header">
    <div class="row">
        ...
        <div class="row justify-content-end">
            <div class="col">
                <a href="<?php echo BASE_URL; ?>/condominio/cadastro" type="button" class="btn btn-warning">Adicionar</a>
            </div>
        </div>
    </div>
</div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="<?php echo BASE_URL; ?>/condominio/ficha/?id=<?php echo $value['id']; ?>" type="button" class="btn btn-outline-info btn-sm"><i class="fas fa-file-alt"></i></a>
                                <a href="<?php echo BASE_URL; ?>/condominio/editar/?id=<?php echo $value['id']; ?>" type="button" class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i></a>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <a href="<?php echo BASE_URL; ?>/condominio/ficha/?id=<?php echo $value['id']; ?>" type="button" class="btn btn-outline-info btn-sm"><i class="fas fa-file-alt"></i></a> Ficha
                                            </li>
                                            <li class="list-group-item">
                                                <a href="<?php echo BASE_URL; ?>/condominio/editar/?id=<?php echo $value['id']; ?>" type="button" class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i></a> Editar
                                            </li>
                                            <li class="list-group-item">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?php echo BASE_URL; ?>/condominio/excluir/?id=<?php echo $value['id']; ?>" type="button" class="btn btn-danger">Sim, deletar condominio</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style>
    #tb_condominios_filter {
        float: right;
    }

    #tb_condominios_paginate {
        float: right;
    }
