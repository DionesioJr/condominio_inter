...
<nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg scrollbar" id="sidebar">
  <div class="container-fluid">
    ...
    <a class="navbar-brand d-inline-block py-lg-2 mb-lg-5 px-lg-6 me-0 d-none d-sm-block d-md-block" href="/">
    ...
    <div class="collapse navbar-collapse" id="sidebarCollapse">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-envelope"></i>Mensagem</a></li>
        <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-kanban"></i> Contas</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/users"><i class="bi bi-people"></i> Usuários</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/configuracao"><i class="bi bi-gear"></i> Configuração</a></li>
      </ul>
